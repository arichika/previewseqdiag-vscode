...
;(function (factory) {
  ...
  // Because of build optimizers
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(7), exports], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Rx, exports) {
...
;(function (factory) {
  ...
  // Because of build optimizers
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(13), exports], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Rx, exports) {
      root.Rx = factory(root, exports, Rx);
      return root.Rx;
    }).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
exports.Misc = Misc;
Misc.previewUri = vscode.Uri.parse('previewSeqDiag://authority/previewSeqDiag');
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.PreviewSeqDiagDocumentContentProvider = void 0;
const vscode = __webpack_require__(1);
const defaultCodeSnippet_1 = __webpack_require__(19);
const mscgenCodeSnippet_1 = __webpack_require__(20);
const mermaidCodeSnippet_1 = __webpack_require__(21);
const suppotablelanguageId = ["mermaid", "mmd", "mscgen", "msgenny", "xu"];
class PreviewSeqDiagDocumentContentProvider {
    constructor() {
        this.latestSnippetResultBuffer = "";
        this.webViewPanel = null;
        this.extentionPath = "";
        this._currentSnippet = defaultCodeSnippet_1.DefaultCodeSnippet.instance;
    }
    ...
    refresh() {
        ...
        switch (editor.document.languageId) {
            case "mermaid":
            case "mmd":
                this._currentSnippet = mermaidCodeSnippet_1.MermaidCodeSnippet.instance;
                break;
            case "mscgen":
            case "msgenny":
            case "xu":
                this._currentSnippet = mscgenCodeSnippet_1.MscgenCodeSnippet.instance;
                break;
            default:
                this._currentSnippet = defaultCodeSnippet_1.DefaultCodeSnippet.instance;
                break;
...
exports.PreviewSeqDiagDocumentContentProvider = PreviewSeqDiagDocumentContentProvider;
...
const vscode = __webpack_require__(1);
const misc_1 = __webpack_require__(17);
class DefaultCodeSnippet {
    ...
    createCodeSnippet(languageId, extentiponPath, webview) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.extractSnippet(languageId, extentiponPath, webview);
        });
    }
    extractSnippet(languageId, extentiponPath, webview) {
        return __awaiter(this, void 0, void 0, function* () {
            let editor = vscode.window.activeTextEditor;
            let text = editor === null || editor === void 0 ? void 0 : editor.document.getText();
            return this.previewSnippet(languageId, extentiponPath, text || "", webview);
        });
    }
    errorSnippet(error, webview) {
        return __awaiter(this, void 0, void 0, function* () {
            return misc_1.Misc.getFormattedHtml("", error, webview);
        });
    }
    previewSnippet(languageId, extentiponPath, payLoad, webview) {
        return __awaiter(this, void 0, void 0, function* () {
            return misc_1.Misc.getFormattedHtml(``, `${payLoad}`, webview);
        });
    }
}
...
class ConfigMscgen {
    constructor() {
        this.fixedNamedStyle = StyleName.classic;
...
class ConfigMermaid {
    constructor() {
        this.fixedStyle = StyleName.forest;
        this.fixedBackgroundColor = backgroundColorDefault;
    }
}
...
const misc_1 = __webpack_require__(17);
const previewSeqDiagDocumentContentProvider_1 = __webpack_require__(18);
function activate(context) {
    const provider = new previewSeqDiagDocumentContentProvider_1.PreviewSeqDiagDocumentContentProvider();
    let showPreview = vscode.commands.registerCommand('previewSeqDiag.showPreview', () => {
        ...
        provider.update(misc_1.Misc.previewUri);
    });
    ...
    vscode_1.window.onDidChangeActiveTextEditor((e) => {
        if (!!e && !!e.document && (e === vscode_1.window.activeTextEditor)) {
            provider.update(misc_1.Misc.previewUri);
        }
    });
    ...
    context.subscriptions.push(vscode.workspace.registerTextDocumentContentProvider(misc_1.Misc.previewUri.scheme, provider));
}
